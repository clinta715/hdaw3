...
namespace IDs {
    ...
    DECLARE_ID(PROJECT)
    DECLARE_ID(SONG_PLAN)

    // Song plan properties (plan/cell workflow, docs/plans/2026-09-11)
    DECLARE_ID(spBpm)
    DECLARE_ID(spKeyRoot)
    DECLARE_ID(spScaleMode)
    DECLARE_ID(spStyle)
    DECLARE_ID(spSeed)
    DECLARE_ID(spTotalBars)
    DECLARE_ID(spBriefJson)
    DECLARE_ID(sectionKind)

    // Cell recipes + fill provenance (plan/cell workflow Phase C)
    DECLARE_ID(CELLS)
    DECLARE_ID(CELL)
    ...
    DECLARE_ID(cellSeed)
    DECLARE_ID(cellLocked)
    DECLARE_ID(cellLastClipId)
    DECLARE_ID(cellLastSeed)
    DECLARE_ID(genTool)
    DECLARE_ID(genSeed)
    DECLARE_ID(genSource)
    DECLARE_ID(genParams)
