...
def main():
    ...
    time.sleep(3.0)  # C2b: let the child's bounded idle clock bake the staged params
                     # (host param -> rate-limited message timer -> Device::process)
                     # before the stopped capture is triggered
