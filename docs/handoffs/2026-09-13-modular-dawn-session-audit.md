...
| B9 ⏳ OPEN | Isolated children render non-deterministically | Engine (proxy respawn) | v1-vs-v2 residual: >95% samples mismatch beyond gain scaling; RMS varies ~±2%. Children re-spawn with free-running phase | A seed-lock option for offline exports — reset the children's phase to a deterministic state at render start |
