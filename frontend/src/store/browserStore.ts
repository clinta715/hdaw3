...
export type FileKindFilter = "all" | "devices" | "presets" | "samples" | "clips" | "midi" | "library" | "pool";
...
function loadKindFilter(): FileKindFilter {
  try {
    ...
    if (raw === "all" || raw === "devices" || raw === "presets" || raw === "samples" || raw === "clips" || raw === "midi" || raw === "library" || raw === "pool") return raw;
    return "all";
  } catch {
    return "all";
  }
